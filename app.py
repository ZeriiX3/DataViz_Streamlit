...
from sections.deep_dives import render as render_deep_dives   # <-- NEW
...
with st.sidebar:
    ...
    if st.button("↺ Réinitialiser les filtres"):
        ...
        st.session_state["flt_types"]   = list(types)
        st.session_state["flt_arr"]     = list(arr_all)
